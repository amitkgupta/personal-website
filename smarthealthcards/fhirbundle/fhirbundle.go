...
func NewJWSPayload(fb FHIRBundle) jwsPayload {
    return jwsPayload{
        Issuer: "https://akgupta.ca/smart-health-cards",
...
func (vt VaccineType) cvxcode() (string) {
    switch vt {
    case Pfizer: return "208"
    case Moderna: return "207"
    case JohnsonAndJohnson: return "212"
    case AstraZeneca: return "210"
    case Sinopharm: return "510"
    case COVAXIN: return "502"
    }
